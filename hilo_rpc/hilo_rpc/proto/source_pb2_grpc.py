...
def add_SourceApiServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateSource': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=proto_dot_source__pb2.CreateSourceRequest.FromString,
          response_serializer=proto_dot_source__pb2.CreateSourceResponse.SerializeToString,
      ),
      'DeleteSource': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteSource,
          request_deserializer=proto_dot_source__pb2.DeleteSourceRequest.FromString,
          response_serializer=proto_dot_source__pb2.DeleteSourceResponse.SerializeToString,
      ),
      'GetSource': grpc.unary_unary_rpc_method_handler(
          servicer.GetSource,
          request_deserializer=proto_dot_source__pb2.GetSourceRequest.FromString,
          response_serializer=proto_dot_source__pb2.GetSourceResponse.SerializeToString,
      ),
  }
