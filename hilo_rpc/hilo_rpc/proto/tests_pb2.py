...
_TESTMESSAGE_ENUM = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='enum', full_name='hilo_rpc.proto.TestMessage.Enum.enum',
...
_TESTMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_TESTMESSAGE_PARAMS, _TESTMESSAGE_ENUM, _TESTMESSAGE_MAPPINGENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TESTMESSAGE_ENUM.oneofs_by_name['enum'].fields.append(
  _TESTMESSAGE_ENUM.fields_by_name['bool_enum'])
_TESTMESSAGE_ENUM.fields_by_name['bool_enum'].containing_oneof = _TESTMESSAGE_ENUM.oneofs_by_name['enum']
_TESTMESSAGE_ENUM.oneofs_by_name['enum'].fields.append(
  _TESTMESSAGE_ENUM.fields_by_name['int32_enum'])
_TESTMESSAGE_ENUM.fields_by_name['int32_enum'].containing_oneof = _TESTMESSAGE_ENUM.oneofs_by_name['enum']
_TESTMESSAGE_ENUM.oneofs_by_name['enum'].fields.append(
  _TESTMESSAGE_ENUM.fields_by_name['string_enum'])
_TESTMESSAGE_ENUM.fields_by_name['string_enum'].containing_oneof = _TESTMESSAGE_ENUM.oneofs_by_name['enum']
